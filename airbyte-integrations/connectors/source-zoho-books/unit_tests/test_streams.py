...
import pytest
from source_zoho_books.source import ZohoBooksStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(ZohoBooksStream, "path", "v0/example_endpoint")
    mocker.patch.object(ZohoBooksStream, "primary_key", "test_primary_key")
    mocker.patch.object(ZohoBooksStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = ZohoBooksStream()
